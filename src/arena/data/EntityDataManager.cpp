...
namespace arena::data
{
	...
	tl::expected<Texture, std::string> EntityDataManager::getRandomEntityTexture(pEntityData entity_data)
	{
		...
		return TextureLoader::get_instance().try_load_image(image_file_path);
	}
	;
